...
PyObject *score_es_c_v3(PyObject *self, PyObject *args) {
...
PyDoc_STRVAR(doc, "score_es_c_v3(vec_1, vec_2, /)");

static PyMethodDef methods[] = {
    {"score_es_c_v3", score_es_c_v3, METH_VARARGS, doc},
    {NULL, NULL, 0, NULL}
};
...
static struct PyModuleDef c_impl_backend = {
    ...
    "c_v3_clang",
    "C implementation of c v3",
    -1,
    methods
};

PyMODINIT_FUNC PyInit_c_v3_clang() {
...
PyMODINIT_FUNC PyInit_c_v3_gcc() {
    _MM_SET_FLUSH_ZERO_MODE(_MM_FLUSH_ZERO_OFF);
    _MM_SET_DENORMALS_ZERO_MODE(_MM_DENORMALS_ZERO_OFF);
