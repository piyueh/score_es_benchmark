...
import math
import numba
from .c_v3_gcc import score_es_c_v3 as score_es_c_v3_gcc
from .c_v3_clang import score_es_c_v3 as score_es_c_v3_clang
...
def score_es_c_v3_numba(preds, obsrvs):
    ...
    match event_size:
        case 1:
            return _score_es_c_v3_numba_1(preds, obsrvs)
        case 2:
            return _score_es_c_v3_numba_2(preds, obsrvs)
        case 6:
            return _score_es_c_v3_numba_6(preds, obsrvs)
        case 12:
            return _score_es_c_v3_numba_12(preds, obsrvs)
        case _:
